...
public class DatabaseModel extends SQLiteOpenHelper {
    ...
    public void deleteRefrany(RefranyDBObject _refrany) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    // Getting All Refranys
    public List<RefranyDBObject> getRefranysByNivell(int _nivell) {
        List<RefranyDBObject> refranysList = new ArrayList<RefranyDBObject>();
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_REFRANYS +" WHERE "+KEY_NIVELL+" = "+_nivell;
